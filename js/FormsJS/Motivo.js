...
function FormatoEstatus(activo)
{
 ...
 function CargarTabla()
    {
      var table = $("#TablaMotivo").DataTable({
      ...
      $('#TablaMotivo tbody').on( 'click', 'tr', function () {
...
function LimpiarCampos()
{
    ...
    if (Idn=="")
      ...
      $.ajax({
        //Ruta para enviar el servicio
        url:'http://localhost:60211/api/v1/GMotivo/'+Idn+'',
        type: 'PUT',
        //Enviamos el arreglo ar
        data: JSON.stringify(arr),
        contentType: 'application/json; charset=utf-8',
...
function ConfirmReactivar() {      
  ...
  function ConfirmGuardar() {     
     bootbox.dialog({
  message: "¿Está seguro de guardar este Motivo?",
  ...
  buttons: {
    ...
    success: {
     ...
     bootbox.dialog({
  message: "¿Está seguro de modificar este Motivo?",
  ...
  buttons: {
    ...
    success: {
     ...
     bootbox.dialog({
  message: "¿Está seguro de Eliminar este Motivo?",
