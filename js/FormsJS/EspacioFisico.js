...
function FormatoEstatus(activo)
{
 ...
 function CargarTabla()
    {
      var table = $("#TablaEspacioFisico").DataTable({
        ...
        "scrollX":        "600px",
           ...
           "ajax": {
            url: ""+ global + "/GEspacioFisicos",
            dataSrc : ''
          }

        });  
      //Al hacer clic en la tabla carga los campos en los TXT
      $('#TablaEspacioFisico tbody').on( 'click', 'tr', function () {
       ...
       var Activo = table.row( this ).data().Activo;
        ...
        var Areas = table.row( this ).data().Areas;
         var Idn = table.row( this ).data().Idn;
        document.getElementById("txtNombre").value = Nombre;
        document.getElementById("txtDescripcion").value = Descripcion;
        document.getElementById("txtArea").value = Areas;
    ...
    //Guardar elementos en DataBase
     function GuardarEspacioFisico() {        
      //Capturar datos del formulario
      var Nombre = document.getElementById("txtNombre").value;
      var Descripcion = document.getElementById("txtDescripcion").value;
       var Areas = document.getElementById("txtArea").value;


      //Agregamos los datos capturados a un arreglo => arr
      var arr = { Nombre:Nombre,Descripcion:Descripcion,Areas:Areas};
      //Evento ajax para enviar los datos
      $.ajax({
        //Ruta para enviar el servicio
        url: ''+ global + '/GEspacioFisico',
        type: 'POST',
    ...
    function ModificarEspacioFisico() {        
      ...
      //Agregamos los datos capturados a un arreglo => arr
      var arr = { Idn:Idn,Nombre:Nombre,Descripcion:Descripcion,Areas:Areas};
    ...
    function EliminarEspacioFisico() {        
...
function LimpiarCampos()
{
    ...
    if (Idn=="")
      ...
      $.ajax({
        //Ruta para enviar el servicio
        url:'http://localhost:60211/api/v1/GEspacioFisico/'+Idn+'',
        type: 'PUT',
        //Enviamos el arreglo ar
        data: JSON.stringify(arr),
        contentType: 'application/json; charset=utf-8',
...
function ConfirmReactivar() {      
  ...
  function ConfirmGuardar() {     
     bootbox.dialog({
  message: "¿Está seguro de guardar este Espacio Fisico?",
  ...
  buttons: {
    ...
    success: {
     ...
     bootbox.dialog({
  message: "¿Está seguro de modificar este Espacio Fisico?",
  ...
  buttons: {
    ...
    success: {
     ...
     bootbox.dialog({
  message: "¿Está seguro de Eliminar este Espacio Fisico?",
