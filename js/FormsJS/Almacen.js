...
function LimpiarCampos()
{
    ...
    if (Idn=="")
      ...
      $.ajax({
        //Ruta para enviar el servicio
        url:'http://localhost:60211/api/v1/GAlmacen/'+Idn+'',
        type: 'PUT',
        //Enviamos el arreglo ar
        data: JSON.stringify(arr),
        contentType: 'application/json; charset=utf-8',
...
function ConfirmReactivar() {      
  ...
  function ConfirmGuardar() {     
     bootbox.dialog({
  message: "¿Está seguro de guardar esta Almacen?",
  ...
  buttons: {
    ...
    success: {
     ...
     bootbox.dialog({
  message: "¿Está seguro de modificar esta Almacen?",
  ...
  buttons: {
    ...
    success: {
     ...
     bootbox.dialog({
  message: "¿Está seguro de Eliminar esta Almacen?",
